...
version_line = open("sensirion_uart_sps30/version.py", "rt").read()
...
setup(
    name='sensirion_uart_sps30',
    version=version_string,
    author='Sensirion',
    author_email='info@sensirion.com',
    description='SHDLC driver for the Sensirion SPS30 sensor family',
    license='BSD',
    keywords="""Sensirion SPS30
        ...
        SPS30""",
    project_urls={
        "Documentation": "https://sensirion.github.io/python-uart-sps30",
        "Repository": "https://github.com/Sensirion/python-uart-sps30",
        "Changelog": "https://github.com/Sensirion/python-uart-sps30/blob/master/CHANGELOG.md",
    },
